...
export default function Home() {
  ...
  return (
    ...
    <h1 className="text-white font-bold text-2xl"><span className="text-blue-500 ml-2"></span></h1>
	  </div>
	  
    <div className="flex h-full min-h-screen flex-col items-center bg-[#0E1117] px-4 pb-20 text-neutral-200 sm:px-10">
		<div className="mt-5 flex flex-col items-center justify-center sm:mt-10">
          <h1 className="text-4xl font-bold"><span className="text-blue-500">AI Code Converter</span></h1>
    ...
    <div className="flex h-full min-h-screen flex-col items-center bg-[#0E1117] px-4 pb-20 text-neutral-200 sm:px-10">
        {/* Your main content */}
        <CodeExecution /> {/* Rendering the CodeExecution component */}
    </div>
